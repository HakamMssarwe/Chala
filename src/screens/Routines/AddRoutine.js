...
export default function AddRoutine({ navigation, route: { params } }) {
    ...
    const handleAddingRoutine = async () => {
        ...
        var response = await HttpRequest("/Routines/CreateRoutine", "post", { Title: title, UserId: params.userId, TagId: selectedTag, StartHour: time.getTime(), Sunday: sunday, Monday: monday, Tuesday: tuesday, Wedensday: wedensday, Thursday: thursday, Friday: friday, Saturday: saturday, IsActive: isActive })
