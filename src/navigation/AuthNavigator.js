...
import { AUTH, FIRST_TIME_LOGIN, LOGIN, SEND_CODE, SETTINGS, SIGNUP, SIGNUP_CODE_SENT, SIGNUP_CODE_VERIFY, UPDATE_PASSWORD, VERIFY_CODE } from '../constants/routeNames';
