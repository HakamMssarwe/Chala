...
export default function ButtonOutline({isLoading,onPress,children,style}) {
    return (
        ...
        <AppText style={{color:style.buttonTextColor?style.buttonTextColor:COLORS.secondary, fontSize:SIZES.paragraph,fontWeight:"bold"}}>{children.toUpperCase()}</AppText>
      </Button>
    )
}
